...
```
curl -o substitutions_raw_DMS.zip https://marks.hms.harvard.edu/proteingym/raw/substitutions_raw_DMS.zip
...
```
curl -o indels_raw_DMS.zip https://marks.hms.harvard.edu/proteingym/raw/indels_raw_DMS.zip
