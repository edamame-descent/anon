...
import calculations # I had to modify the code of evcouplings.mutate.calculations.py to change the separator in extract_mutations from "," to ":".
...
if __name__ == "__main__":
    ...
    # Hardcoding the weird RASK_HUMAN_Ursu case (has a special alignment id since it differs from the other RASK_HUMAN assays)
