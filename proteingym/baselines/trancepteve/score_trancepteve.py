...
def main():
    ...
    #if scoring_EVE_DMS_assays: 
    #DMS_data = dms_utils.DMS_file_cleanup(args.DMS_data_folder + os.sep + DMS_file_name, target_seq=target_seq, DMS_phenotype_name='DMS_score')
    #else:
