...
#SBATCH --output=./slurm/tranception_no_retrieval/trn-medium-%A_%3a-%x-%u.out  # Nice tip: using %3a to pad to 3 characters (23 -> 023) so that filenames sort properly
#SBATCH --error=./slurm/tranception_no_retrieval/trn-medium-%A_%3a-%x-%u.err

#SBATCH --job-name="tranception_M_no_retrieval_DMS_scoring"
# #SBATCH --array=0-82
# #SBATCH --array=1-82  # 9 Aug: Lood running all
#SBATCH --array=15
