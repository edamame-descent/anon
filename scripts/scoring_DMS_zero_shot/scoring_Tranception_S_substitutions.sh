...
#SBATCH --output=./slurm/tranception/tranception-small-%A_%3a-%x.out   # Nice tip: using %3a to pad to 3 characters (23 -> 023)
#SBATCH --error=./slurm/tranception/tranception-small-%A_%3a-%x.err   # Optional: Redirect STDERR to its own file
#SBATCH --job-name="tranception_s_scoring"
# #SBATCH --array=3-7,9,10,12-82
# #SBATCH --array=3,17,20,22,29,45,59,71
...
export PATH_TO_OUTPUT_SCORES=/n/groups/marks/projects/marks_lab_and_oatml/ProteinGym/model_scores/zero_shot_substitutions/v2_scores/Tranception/Tranception_S
