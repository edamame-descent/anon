...
export data_path=/n/groups/marks/projects/marks_lab_and_oatml/protein_transformer/Tranception_open_source/DMS_files/ProteinGym_indels
export output_dir=/n/groups/marks/projects/marks_lab_and_oatml/protein_transformer/model_scores/Unirep_evotune/indels
