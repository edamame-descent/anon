...
#SBATCH -t 48:00:00
#SBATCH --mem=90G
#SBATCH --output=./slurm/progen2/%A_%4a-%x-%u.out 
#SBATCH --error=./slurm/progen2/%A_%4a-%x-%u.err
#SBATCH --job-name="ProGen2_clinical_subs"
...
#export output_scores_folder="${clinical_output_score_folder_subs}/Progen2/bfd90"
